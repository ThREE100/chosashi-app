...
- **現行法令チェック（2026-08-03実施）**：本記事が引用する条文（法53条1項、民法252条ただし書、法48条3項、法47条2項）についてWebSearchで現行の内容を確認しました。イの根拠として引用していた「民法252条ただし書」は、令和3年民法改正（令和5年4月1日施行）により共有物の管理に関する規定が再構成された結果、保存行為の規定はただし書ではなく独立した項（民法252条5項「各共有者は、前各項の規定にかかわらず、保存行為をすることができる。」）に置かれるようになっています。内容（共有者の1人が保存行為として単独で申請できる）自体に変更はありませんが、条文の引用形式が現行と食い違っていたため、本文・確認事項・インフォグラフィックプロンプートの該当箇所を「民法252条ただし書」から「民法252条5項」に修正しました。ア(法53条1項)・ウ(法48条3項)・オ(法47条2項)はWebSearchで確認した限り現行条文と一致しており、条番号・内容とも修正不要でした。
