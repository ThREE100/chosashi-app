...
177条の「第三者」とは、当事者もしくはその包括承継人以外の者で、登記の欠缺を主張するにつき正当な利益を有する者をいうと解されています（大連判明41.12.15）。背信的悪意者ではない単純悪意者もこの「第三者」に含まれるため、Bは登記をしなければCに対抗することができません（最判昭32.9.19）。
...
「登記の欠缺を主張する正当な利益を有する者かどうか」という一点に立ち返って各肢を検討すると、判断がぶれません。
