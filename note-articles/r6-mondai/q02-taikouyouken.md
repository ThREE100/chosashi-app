## 【土地家屋調査士受験生向け】令和6年度 第2問〜登記なしで対抗できる5つの除外類型〜
...
- 各肢の根拠について、エ（民法896条本文）はデータベースのexplanationフィールドで条文番号まで明記されているものです。イについては明示の判例・条文番号はなく、177条の「第三者」概念からの一般的な推論にとどまります。オ（不法占拠者は「第三者」にあたらない）については、データベース上の判例citationがOCR起因と思われる不明瞭な記載だったため、改めてWeb検索で出典を確認し、正しくは最判昭25.12.19（民集4巻12号660頁）であることを特定した上で本文に反映しています。
