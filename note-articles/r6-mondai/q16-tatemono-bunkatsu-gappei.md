...
- 各肢の条文根拠のうち、イ（不動産登記法56条5号）、ウ（不動産登記法58条4項・56条1号）、オ（不動産登記法40条・54条3項）は、データベースのexplanationフィールドで条文番号まで明記されています。一方、ア（表題部所有者自身が申請人となる場合に印鑑証明書が不要である点）とエ（分棟・分割登記の一括申請が特別に認められる点）は、explanationフィールドに条文番号の明記はなく、実務上の取扱いとしての説明にとどまっているため、断定的な条文引用は避けています。
