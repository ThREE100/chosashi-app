...
地図にある土地の区画又は地図に準ずる図面にある土地の位置・形状に誤りがある場合、原則として誤りがあることを証する情報と併せて、土地所在図又は地積測量図を提供しなければなりません（不動産登記規則16条6項〜9項）。ただし、登記所に備え付けられている図面で誤りが確認できる場合は、当該図面を特定する情報を提供すれば、誤りがあることを証する情報の提供を省略することができます。
