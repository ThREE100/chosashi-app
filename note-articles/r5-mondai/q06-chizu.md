...
- **ア（正）**　地図作成の測量は電子基準点を基礎として行える
- **イ（誤）**　記録するのは基本三角点等の「位置」で、名称・座標値は記録事項ではない
- **ウ（正）**　国土調査法19条5項の指定を受けた実測図は地図として備え付けられる
- **エ（誤）**　閉鎖された図面も認証文付きの写しの交付を請求できる
- **オ（誤）**　地積の差が公差の範囲内なら、地積更正を併せてする必要はない
