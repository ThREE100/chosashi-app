...
- **ローカル法令データベースでの再検証（2026-08-13実施）**：note-articles/laws/配下の条文原文と照合しました。民法252条5項「各共有者は、前各項の規定にかかわらず、保存行為をすることができる。」（オ）、不動産登記法47条1項・2項（ア）、44条1項4号「建物の名称があるときは、その名称」（ウ）、48条1項（エ）は、いずれも条文原文と一致することを確認しました。相違なし。正解（選択肢4番＝イオ）はQ13=④の公式正解と一致しており、相違ありません。
