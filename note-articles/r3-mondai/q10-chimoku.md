## 【土地家屋調査士受験生向け】令和3年度 第10問〜ペットのお墓は「墓地」にならないんです〜
...
- **ア（誤）** 急傾斜地の防災用擁壁が占める土地は「堤」ではなく「雑種地」
- **イ（正）** ため池のえん堤もため池の一部として「ため池」に含める
- **ウ（誤）** 「墓地」は人の遺骸・遺骨を埋める土地。動物は含まず「雑種地」
- **エ（正）** 宗教法人の聖堂が存する土地は「境内地」
- **オ（誤）** 着工前で仮設事務所のみでは宅地にできない
