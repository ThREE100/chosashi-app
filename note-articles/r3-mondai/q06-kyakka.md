...
- **ウ（正）** 基本三角点等を利用できるのに利用しない地積測量図は却下される（規則77条1項7号・8号)
- **エ（正）** 補正できる不備を期間内に補正すれば却下されない（法25条ただし書)
- **オ（誤）** 電子申請の却下決定書も電磁的記録ではなく書面で作成される（規則38条1項・2項)
