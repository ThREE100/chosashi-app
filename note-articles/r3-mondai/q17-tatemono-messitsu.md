...
- 肢エの問題文は出題当時「所有権を証する情報」と記載されており（「所有者を証する情報」ではありません）、この点はデータベース上でも指摘されています。上記の引用・本文は出題当時の表現「所有権を証する情報」に統一しています。条文の趣旨としては所有者（＝所有権者）であることを示す情報を要する点で結論は変わりませんが、答案等では出題当時の表現の細部にも注意してください。
