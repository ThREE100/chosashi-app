...
- 各肢の根拠条文は、note-articles/laws/配下のローカル法令データベース（不動産登記法・同令別表）の条文原文とすべて突き合わせて確認しました。一致を確認できたもの：ア（不動産登記規則35条6号＝一の申請情報での申請）、ウ（不動産登記令別表2項添付情報ロ＝住所を証する情報／不動産登記法33条3項＝共有者の1人からの申請）。
