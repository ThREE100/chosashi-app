...
- **ア（誤）** 所在欄は主である建物の土地の地番が先に記録される（附属建物が広くても同じ、準則88条2項）
- **イ（誤）** 地番区域でない字も所在欄に記録する。省略不可（昭41.1.11民甲229号）
- **ウ（誤）** 一棟の建物の名称の登記に、規約設定を証する情報は不要（令別表十二の項）
...
- 各肢の根拠について、条文・先例レベルで確認できたものと一般原則からの推論とを区別すると、次のとおりです。イ（昭和41年1月11日民甲229号回答）、エ（昭和37年6月11日民甲1559号）、オ（平成21年2月20日民二500号）は、データベースのexplanation・pitfallsに先例番号まで明記されている先例です（laws/には判例・先例は収録されていないため、実在の常識的な確認にとどめています）。ア（附属建物の床面積の大小にかかわらず主である建物の土地の地番が先に記録されること）は、不動産登記事務取扱手続準則第88条第2項（「床面積の多い部分又は主たる建物の所在する土地の地番を先に記録し、他の土地の地番は後に記録する」）の条文で確認済みです。ウ（一棟の建物の名称の登記に規約設定を証する情報が不要であること）は、不動産登記令別表十二の項の添付情報欄（建物の表題登記）に一棟の建物の名称に関する規約設定証明情報が列挙されていないことで確認済みです。いずれもnote-articles/laws/配下の該当ファイルをGrepして照合しました。
