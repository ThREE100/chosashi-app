## 【土地家屋調査士受験生向け】令和3年度 第18問・その建物、誰が「共用部分」にできる？〜共用部分・団地共用部分である旨の登記のルール〜
...
- 条文レベルで確認できた根拠と、一般原則からの推論を区別して整理すると、次のとおりです。
  ...
  - 肢イ・肢オの「規約設定を証する情報／抵当権者の承諾を証する情報」の要否は、データベース上、不動産登記令別表（18項）を根拠とする記述と、不動産登記法58条各項を根拠とする記述の両方が併存しています。共用部分である旨の登記に添付情報として規約設定証明情報・利害関係人の承諾情報が必要である、という結論自体はデータベースで一致しています。WebSearchでの確認では、権利登記名義人（抵当権者を含む）の承諾を要する旨は法58条3項に規定されていることを確認しましたが、令別表18項の枝番との対応関係まではe-Gov原文での最終確認をおすすめします。
  - 肢ア（申請人適格＝当該区分建物自身の所有権の登記名義人に限られる）については、データベース内で不動産登記法58条1項とする記述と58条2項とする記述が併存していましたが、WebSearch（e-Gov法令検索への直接アクセスは本環境では403エラーで不可のため、二次資料経由）で確認したところ、申請人適格（表題部所有者又は所有権の登記名義人以外の者は申請できない旨）は58条2項に、権利登記名義人の承諾（肢イ・オに関連）は58条3項に規定されていることを確認しました。「他の区分建物の所有権の登記名義人は申請できない」という結論はデータベースと一致しており、条項は58条2項として問題ありません。
