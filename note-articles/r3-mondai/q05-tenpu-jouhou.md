...
- なお、データベース内では共通添付情報の援用の根拠として、explanationフィールドが「不動産登記規則37条1項」、keyPointsフィールドが「不動産登記令7条」と、参照条文にゆれがありました。本記事はexplanationの記載（規則37条1項）に合わせていますが、条文番号そのものは受験教材等で改めて確認されることをおすすめします（援用が認められること自体は両フィールドで一致しています）。
