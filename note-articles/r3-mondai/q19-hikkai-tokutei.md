...
- 条文レベルで確認できた根拠：エ（提出資料の閲覧請求権者を申請人・関係人に限る＝不動産登記法141条1項）は、データベースのexplanationフィールドで条文番号まで明記されているものです。ア・オの申請人適格については、keyPointsが「不動産登記法131条（所有権の登記名義人・表題部所有者・未登記の所有者）」を根拠として挙げているため本文でも131条を採用しました。なお同じデータベースのexplanationフィールドでは申請人適格の根拠を「法123条5号」と表記しており、条文番号の表記に揺れがあります。本文では申請人の要件を定める規定として131条を採用していますが、正確な条番号はe-Gov法令検索等でご確認ください。
