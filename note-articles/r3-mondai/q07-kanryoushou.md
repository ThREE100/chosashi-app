## 【土地家屋調査士受験生向け】令和3年度 第7問・登記完了証には何が書かれる?〜記録事項・通知方法・電子申請の落とし穴〜
...
- 肢オの根拠について、WebSearch（e-Gov法令検索への直接アクセスは本環境では403エラーで不可のため、二次資料経由）で確認しました。不動産登記規則182条の2第1項は、電子情報処理組織を使用した送信の方法による場合（同項1号）は送信可能時から「30日」、送付・交付による場合（同項2号）は登記完了時から「3か月」を経過してもファイルへの記録・受領がないときに、登記官が完了通知を要しない旨を定めています。本問の肢オは「電子申請」の場面を「3か月」で説明しており、電子申請（送信方式）に対応する正しい期間は30日であるため、期間を取り違えている点で誤りです。データベースのpitfalls欄にあった「3か月・規則182条3項でオは正しい」という記述は、送付・交付方式の期間を電子申請の場面に誤って当てはめたものと考えられ、正解（アオ＝オが誤り）とも整合しません。本記事の記載（30日・規則182条の2第1項）は妥当と確認できました。
