...
電子申請でされた登記が完了した場合、登記完了証を電子情報処理組織で送信することが可能になった時から一定期間が経過してもファイルに記録（受信）しないときは、登記官は登記が完了した旨の通知をすることを要しないとされています（不動産登記規則182条の2第1項1号）。この期間は「3か月」ではなく「30日」であり、また効果も「登記完了証が廃棄される」ではなく「通知をすることを要しない」（その結果として登記完了証を廃棄することができる、という任意の扱い）です。したがって、期間を3か月とし、効果を廃棄とする本肢は誤りです。
...
- **イ（正）** 申請人が複数でも、一人に通知すれば足りる（規則181条1項後段）
