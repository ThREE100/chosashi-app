...
- ウの論点について：「遺産共有の解消は遺産分割によるべきで、通常の共有物分割請求はできない」という原則自体は現行法でも変わりません。ただし令和5年4月1日施行の民法258条の2により、相続開始の時から10年を経過したとき(かつ相続人からの異議がないとき)に限り、通常の共有物分割請求でも遺産共有持分を解決できるという例外が新設されています。本問は相続開始からの経過期間が示されておらず、この例外の適用場面ではないため、正解(ウは誤り)には影響しません。現行法を学習する際は、この10年ルールの存在も併せて押さえておいてください。
