## 【土地家屋調査士受験生向け】平成24年度 第13問〜床面積の誤り、更正登記に申請義務はないんです〜
...
表題登記がある建物の所在する行政区画の名称（市町村名など）に変更があった場合、不動産登記規則92条1項により、登記記録に記録した行政区画又はその名称について変更の登記があったものとみなされる扱いとなっており、表題部所有者に1か月以内の申請義務が課されるものではありません。

**たとえば**、市町村合併によって建物の所在地の名称が変わった場合、その建物の表題部所有者があらためて変更登記を申請する必要はなく、登記記録上の表示も名称変更にあわせて変更があったものとして扱われます。
...
建物の表示に関する登記の申請義務に関する5肢を、「1か月以内の申請義務があるもの」と「申請義務がない・起算点に注意すべきもの」という2つの軸に沿って、通し番号バッジ・短い見出し・図解・短い結論タグだけで構成する2列・5枚のポスター型カードで俯瞰する構成。

```
Create a Japanese-language infographic, portrait layout, 1080x1920 pixels,
clean flat-design isometric illustration style with soft pastel colors
(blue, green, beige, gray), rounded card sections, consistent with a
modern explainer-graphic aesthetic (icons: isometric calendar with a
circled deadline, condominium common room, two buildings merging into
one, city hall/administrative boundary sign, ruler measuring a floor
plan, etc. — adapt icon set to the topic).
...
--- HEADER ---
Title (large, bold, 1行):
床面積の誤り、更正登記に申請義務はないんです

Subtitle (smaller, centered, 1行):
平成24年度 午後の部 第13問－建物の表示登記の申請義務
...
規約廃止後は1か月以内に申請
Illustration: A condominium common room icon with a "規約廃止" document,
next to a calendar showing a circled "1か月" deadline.
...
Heading: 建物合体も1か月以内に申請
Illustration: Two separate buildings merging into one via a construction
arrow, next to a calendar showing a circled "1か月" deadline.
Conclusion tag: 1か月以内に申請
...
Heading: 床面積の更正に申請期限なし
Illustration: A floor-plan ruler icon showing a measurement error being
corrected, with a calendar deadline crossed out with an "✕" (no time
limit).
Conclusion tag: 申請期限はない

--- COLUMN B, CARD 4 ---
Badge: a filled green circle containing the number 4.
Heading: 起算点は所有権を取得した日
Illustration: A calendar with two candidate start dates — "改築完了日"
crossed out with an "✕" and "所有権取得日" circled with a checkmark.
Conclusion tag: 取得日から起算

--- COLUMN B, CARD 5 ---
Badge: a filled green circle containing the number 5.
Heading: 市町村名変更はみなし変更
Illustration: A city-hall icon with an administrative-boundary name
change sign, an automatic "みなし変更" stamp appearing on the registry
record with no application form needed (crossed out with an "✕").
Conclusion tag: 申請不要、みなし変更
...
the same 1-month deadline. Unlike a glanceable summary poster, each panel
...
Subtitle (smaller, centered, 1行):
平成24年度午後第13問 作図ガイド（建物表示登記の申請義務）
...
with a large red ✕): a calendar icon with a circled 1か月 deadline next
to a floor-plan ruler correcting a 床面積の誤り. Right side (labeled 正し
いルール, marked with a large green checkmark): the same floor-plan
correction scene, but the calendar's 1か月 deadline circle is faded out /
dotted-outline, labeled 期限の定めなし（更正の登記）.
着眼点 callout (1-2 sentences, verbatim, must state the checking order):
まず、床面積の誤りを正す登記が、現況の変化を反映する変更の登記ではなく、
更正の登記にあたることを確認します。次に、変更の登記のような1か月以内の
申請義務を課す条文があるかを確認すると、更正の登記にはそのような期限の
定めがありません。
...
Heading (bold, ONE line):
起算点は所有権取得日で改築完了日でない
Diagram: A left-to-right timeline with three dated markers: ①事務所として
の表題登記（既存） → ②Aが改築工事を完了し居宅に変更 → ③Bが所有権を取得。
From marker ②, an arrow labeled 改築完了日から1か月 is drawn crossed out
with a red ✕. From marker ③, an arrow labeled 所有権取得日から1か月 is
drawn with a green checkmark, leading to a 表題部変更登記の申請 icon.
着眼点 callout (1-2 sentences, verbatim, must state the checking order):
まず、建物の用途変更の登記の申請義務が生じる場面かどうかを確認します。
次に、変更後に所有権を取得した者については、改築工事が完了した日では
なく、所有権の登記があった日を起算点として1か月以内に申請しなければ
ならないと確認します。
Conclusion tag (a short colored banner/pill, green, 5-15 Japanese
characters):
取得日から1か月以内
...
Diagram: A left-to-right timeline with two dated markers: ①共用部分である
旨の登記がある建物について、規約を廃止 → ②その日から1か月以内、という
circled deadline on a calendar icon, leading to a 建物の表題登記の申請
icon marked with a green checkmark.
着眼点 callout (1-2 sentences, verbatim, must state the checking order):
まず、共用部分である旨を定めた規約が廃止されたかを確認します。廃止され
た場合は、次に、その廃止の日を起算点として1か月以内に建物の表題登記を
申請しなければならないと確認します。
Conclusion tag (a short colored banner/pill, green, 5-15 Japanese
characters):
廃止日から1か月以内
...
ものとみなされる扱いであることを確認し、表題部所有者に1か月以内の申請
義務が課されるわけではないと判断します。
...
Heading (bold, ONE line):
合体日から1か月以内に2つの登記が必要
Diagram: A left-to-right timeline with two dated markers: ①表題部所有者A
の甲建物と、表題登記のない所有者Bの乙建物が、改築工事により1個の建物と
なる（合体） → ②その日から1か月以内、という circled deadline on a
calendar icon. From the deadline, TWO separate arrows point to two
document icons, both marked with a green checkmark: 合体後の建物につい
ての表題登記 and 合体前の甲建物についての表題部の登記の抹消.
着眼点 callout (1-2 sentences, verbatim, must state the checking order):
まず、甲建物と乙建物が改築工事によって1個の建物になったかを確認します。
次に、その合体の日を起算点として1か月以内に、合体後の建物についての
表題登記と、合体前の甲建物についての表題部の登記の抹消の両方を申請しな
ければならないと確認します。
Conclusion tag (a short colored banner/pill, blue, 5-15 Japanese
characters):
表題登記と抹消の両方必要
...
不動産登記法51条1項・2項（変更の登記の申請義務）・53条（更正の登記）・58条
6項（規約廃止後の表題登記）・49条1項（建物の合体）、不動産登記規則92条
1項（行政区画・名称の変更）に基づく整理です。

Final check before rendering: scan every kanji glyph and confirm it is
standard Japanese (Jōyō) form, not Simplified Chinese and not Traditional
Chinese, paying special attention to 床, 面, 積, 誤, 更, 正, 改, 築, 共,
用, 規, 約, 廃, 止, 行, 政, 区, 画, 合, 体 and any character that has a
visually similar Simplified or Traditional Chinese variant. If any
