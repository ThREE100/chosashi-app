...
### エ：本人の指名どおりに選んでも、不適任と知って放置すれば責任を負う（※現行法での根拠は変化）

この肢は平成24年当時の民法105条2項ただし書（代理人が本人の指名に従って復代理人を選んだ場合、原則としてその選任・監督についての責任を負わないが、復代理人が不適任・不誠実であると知りながら本人への通知や解任を怠ったときは責任を負う、という規定）を根拠とする正しい記述でした。

もっとも、この105条2項ただし書（当時の任意代理人の復代理人選任責任を軽減する規定）は、令和2年4月1日施行の民法（債権関係）改正で**削除**されています。現行の民法105条は条文番号としては存続していますが、中身は入れ替わっており、現在は「法定代理人は、自己の責任で復代理人を選任することができる。この場合において、やむを得ない事由があるときは、本人に対してその選任及び監督についての責任のみを負う。」という、法定代理人による復代理人選任の規定になっています（つまり105条を条文検索しても、当時この肢の根拠だった任意代理人の責任軽減規定は出てきません）。現行法の下では、任意代理人が復代理人を選任した場合の責任は、この種の特別な軽減規定によってではなく、本人と代理人との間の委任契約の解釈に基づく、債務不履行責任の一般原則によって判断されます。もっとも、「本人の指名どおりに選んだのに、不適任・不誠実と知りながら通知や解任を怠った」という事情は、この一般原則のもとでも代理人の善管注意義務違反を基礎付ける事情として考慮されうるため、実務的な結論（知りながら放置すれば代理人が責任を負う方向に傾く）自体は現在も大きくは変わらないと考えられますが、「原則免責、ただし書で例外的に責任」という条文構造そのものはもはや存在しない点に注意してください。

**たとえば**、本人Xから「あなたの知り合いのBに手続を任せてほしい」と指名されて代理人AがBを復代理人に選んだ場合、Bが不誠実な対応を繰り返していることにAが気づいたのに、Xに知らせず、Bを解任もしなかったとします。平成24年当時であれば「105条2項ただし書によりAが責任を負う」と説明できましたが、現行法のもとでは、Aが委任契約上の善管注意義務を尽くしたといえるかという一般的な債務不履行責任の枠組みで、同様の結論（Aの責任）が導かれると考えられます。
...
- **エ（正）**　出題当時は改正前民法105条2項ただし書により正しい記述だった（同条は令和2年4月施行の改正で削除、現在は債務不履行の一般原則で判断）
