## 【土地家屋調査士受験生向け】平成24年度 第9問〜地積が変わるなら、訂正じゃなく更正登記なんです〜
...
地積測量図の訂正の申出は、表題部所有者若しくは所有権の登記名義人又はこれらの相続人その他の一般承継人がすることができます（不動産登記規則88条1項）。訂正の申出は正確な記録を回復するための保存行為なので、相続人が数人いても、そのうちの一人が単独で申し出ることができます（民法252条5項）。問題文は「一人ではできない」としており、その点が誤りです。
...
地積測量図を添付情報とする表題部の登記事項に関する更正の登記ができる場合には、地積測量図の訂正の申出をすることはできません（不動産登記規則88条1項ただし書）。求積方法の誤りで登記記録の地積と正しい地積が異なるのは、まさに地積に関する更正の登記によるべき場面なので、訂正の申出はできません。
...
訂正の申出ができるのは所有権の登記名義人などであり（不動産登記規則88条1項）、登記記録の住所と現住所が異なっても、住所に変更があったことを証する情報（住民票の写しなど）を申出情報と併せて提供して同一性を示せば申出ができます。登記名義人の住所の変更の登記を先に済ませておく必要はありません。
...
委任状には申出人が署名するか記名押印すれば足り、その印鑑証明書の添付までは求められません。訂正の申出に準用されるのは委任状への記名押印を定める不動産登記令18条1項までで、印鑑証明書の添付を定める同条2項は準用されていないからです（不動産登記規則88条3項、16条10項）。問題文は「添付しなければならない」としており、その点が誤りです。

**たとえば**、土地家屋調査士に地積測量図の訂正の申出を依頼する場合、依頼者は委任状に記名押印すれば足り、実印による押印や印鑑証明書の提出まで必要とされるわけではありません。

### オ：訂正事由が資料から明らかでも、訂正後の図面の提供は省略できない

地積測量図の訂正の申出は、訂正後の地積測量図を提供してしなければなりません（不動産登記規則88条2項）。訂正事由が登記所備付けの資料から明らかな場合を除くという例外はないので、地番の誤りの訂正でも訂正後の図面の提供は省略できません。
...
- **ア（誤）**　相続人の一人からでも地積測量図の訂正の申出はできる（規則88条1項、民法252条5項）
- **イ（誤）**　地積の更正の登記ができる場合は、訂正の申出はできない（規則88条1項ただし書）
- **ウ（正）**　住所変更を証する情報を提供すれば、住所相違があっても申出できる（規則88条1項）
- **エ（誤）**　委任状への押印について、申出人の印鑑証明書の添付までは求められない（規則88条3項・16条10項）
- **オ（正）**　訂正事由が資料から明らかでも、訂正後の地積測量図の提供は省略できない（規則88条2項）
...
- 各肢の法的根拠は、いずれも不動産登記規則88条（土地所在図の訂正等）とその準用先の条文原文で確認済みです。ア＝88条1項の申出権者（＋保存行為に関する民法252条5項）、イ＝88条1項ただし書、ウ＝88条1項、エ＝88条3項が準用する規則16条10項（不動産登記令18条1項のみを準用し、印鑑証明書の添付を定める同条2項は準用していない）、オ＝88条2項です。
- **適用法令の現行性チェック（2026-08-06実施）**：`note-articles/laws/`のローカル法令データベース（2026-08-04時点のe-Gov現行版）で、不動産登記規則88条・16条・77条、不動産登記令16条〜19条、民法252条の原文を確認しました。その結果、従前「条文番号までは特定できていない」としていたイ（規則88条1項ただし書＝表題部の登記事項に関する更正の登記ができる場合は訂正の申出をすることができない）とエ（令18条2項が準用対象から外れていること）を、いずれも条文レベルの根拠に差し替えています。これらの条文に本問の結論を左右する改正はなく、令和3年法律24号（相続登記の義務化等）や令和5年施行の民法改正も、図面の訂正の申出の規律には及んでいません（民法252条5項の保存行為の規律も令和3年改正の前後で実質的に同じです）。**5肢すべての正誤判定と正解（ウオ＝選択肢5番）に変更はありません。**
- **重複出題チェック（2026-07-22実施）**：takuitsu.jsonを検索し、平成25年度から令和7年度までの試験問題全体で「地積測量図」がテーマの問題を確認しました。令和7年度第9問が「地積測量図」を題材としていますが、内容は地積測量図の記録事項・作成要件（筆界点の永続的標識の記録、地積の記録省略の可否、土地所在図との兼用等）であり、本問がテーマとする「地積測量図の訂正の申出」の手続要件（訂正申出権者、訂正と更正登記の使い分け、代理権限証書の要否、訂正後図面の提供義務）とは異なる論点です。**内容の重複は見つかりませんでした。** 令和8年度以降の試験がデータベースに追加された際は、この確認を再実施してください。
