...
建物図面及び各階平面図を書面で作成する場合の線の太さについて、「0.3ミリメートル以下」という数値は正確ではありません。不動産登記規則74条1項は、土地所在図・地積測量図と同様に、これらの図面（書面である場合に限る）を「〇・二ミリメートル以下の細線により、図形を鮮明に表示しなければならない」と定めており、実際にはより細い線（0.2ミリメートル以下）が求められています。

**たとえば**、手書きで建物図面を作成する場合、線が太すぎると図面上の位置や形状が不正確に見えてしまうため、細い線で正確に描くことが求められます。

### ウ：極めて小さくなる建物は、位置のみ記入して余白に拡大表示できる

建物図面の作成にあたり、建物がその図面上において極めて僅少（小さく）となり、形状を図示することが難しいときは、その位置のみを記入したうえで、用紙の余白の適宜の箇所に、適宜の縮尺で拡大表示し、その位置・形状・縮尺を明らかにすることができます（先例・昭和39年10月2日民事甲第3191号）。このとき、本図と余白の拡大図とで方位を揃えておく必要があります。

**たとえば**、非常に小さい附属建物があり、通常の縮尺ではほとんど点のようにしか描けない場合には、正確な位置だけを本図に記入し、方位をそろえたうえで余白に拡大した図を別途描いて、その建物の形状を分かりやすく示すことができます。
...
附属建物の新築による建物の表題部の変更の登記を申請する際に提供すべき建物図面は、新築された附属建物の部分だけでなく、主である建物も含めて記録しなければなりません。建物図面は、常に1個の建物（主である建物＋附属建物）全体を表示するものだからです（不動産登記規則81条、先例・昭和37年10月1日民事甲第2802号）。この扱いは各階平面図には及ばず、各階平面図の方は新築に係る附属建物の分だけを提供すれば足りる点で、建物図面とは扱いが異なります。
...
- **イ（誤）**　書面作成時の線の太さは「0.3ミリメートル以下」ではなく「0.2ミリメートル以下」（不登規則74条1項）
- **ウ（正）**　極めて小さくなる建物は、位置のみ記入して余白に拡大表示できる（先例・昭39.10.2民甲3191号）
- **エ（誤）**　各階平面図の縮尺は、250分の1が適当でない場合でも「500分の1」に限定されない（不登規則83条2項）
- **オ（正）**　附属建物新築による変更登記でも、建物図面は主である建物も含めて記録する（不登規則81条、先例・昭37.10.1民甲2802号）
