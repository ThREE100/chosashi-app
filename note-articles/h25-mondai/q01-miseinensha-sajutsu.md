## 【土地家屋調査士受験生向け】平成25年度 第1問〜「知っていたのに騙された」は通用しない〜
...
- **ア（誤）**　相手方が未成年者だと知っていれば、詐術を用いても取消しは制限されない
- **イ（正）**　未成年者は、法定代理人の同意を得れば成年に達する前でも追認できる
- **ウ（正）**　法定代理人への催告に無回答なら追認したものとみなされる
- **エ（誤）**　取消しの意思表示は契約の相手方にすれば足り、転得者への意思表示は不要
- **オ（正）**　成年に達した後、異議なく履行を受ければ法定追認が成立する
...
- **間違いノート補足（2026-09-18追加）**：読者からア・エの結論に自力でたどり着けなかったというフィードバックを受け、それぞれ「ここが分かりにくいポイント」の解説を追加しました。アは「詐術＝即取消し不可」という一直線の理解ではなく、詐術と相手方の誤信との因果関係が要件であること（相手方が悪意なら21条は適用されない）を、エは「意思表示の相手方（123条、常に契約の直接の相手方）」と「第三者との対抗関係（177条等の別問題）」という2つのレイヤーの混同が誤りの原因であることを、それぞれ説明しています。正誤判定・正解（アエの組合せ、選択肢2番）自体に変更はありません。あわせて、アの解説を関連付ける過程で`topics/mikoseinensha.md`の詐術（21条）に関する記述に、相手方の善意・悪意を問わないとする誤りを発見したため、別途訂正しました（本問の解説とは矛盾しない内容に統一済みです）。タイトルのキャッチフレーズ（「知っていたのに騙された」は通用しない）は、既にアの論点を的確に捉えているため変更していません。
