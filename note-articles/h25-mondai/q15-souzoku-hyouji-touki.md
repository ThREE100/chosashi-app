...
**補足**：分筆の登記が原則として持分の過半数を有する者からの申請を必要とするのは、共有物の管理行為として扱われるためです。遺産分割協議書の提供によってこの原則が修正され、協議によって当該土地を取得することになった相続人が申請できるようになる、という関係を押さえておくと理解しやすくなります。なお、本肢のようにA・Bの双方がそれぞれ別の土地（分筆後の甲・乙）を取得する場合に、A又はBの一方だけで単独に分筆の登記を申請できるかどうかについては、確認できた資料の範囲では明確な結論が得られませんでした。本肢が問うている「A及びBが共同して申請する」方法が、少なくとも確実に認められている方法です。いずれにしても、遺産分割協議の結果、甲土地・乙土地のいずれも取得しないCが、この分筆の登記を申請することはできません。
...
- **最新法令チェック**：相続登記義務化（不動産登記法76条の2、令和6年4月1日施行）による影響を特に注意して確認しました。本問は「相続があった場合の表示に関する登記」を扱っていますが、相続登記義務化が新設したのは相続による所有権の移転の登記（権利に関する登記）を申請する義務であり、本問の各肢が扱う表題登記・表題部の変更の登記・滅失の登記の申請手続そのもの（誰が申請できるか、どの添付情報が必要か）にルール変更はありません。住所変更登記義務化（同法76条の5、令和8年4月1日施行・施行済み）についても、本問の各肢は住所変更を扱っていないため影響はありません。
