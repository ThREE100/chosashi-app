## 【土地家屋調査士受験生向け】令和元年度 第6問・その土地、本当に「なくなった」の？滅失登記の分かれ道〜地目変更か滅失か、期間の起算点はいつか〜
...
土地の滅失について「人工的な原因か自然的な原因か」で地目変更・滅失を見分ける4枚と、申請期間の起算点という手続の基本ルールを1枚の、通し番号バッジ・短い見出し・図解・短い結論タグだけで構成する計5枚のポスター型カードで俯瞰する構成。
...
令和元年度 午後の部 第6問－地目変更・滅失・地積変更の見分け方
...
人工的に掘った池は地目変更
Illustration: An isometric land plot showing a person digging a hole with
a shovel, water filling the hole to form a small pond. A wooden signboard
on the plot flips from 「畑」 to 「池沼」. A green checkmark stamp reads
「地目変更」, while a separate red stamp reading 「滅失」 has a large red
X mark over it to show this is NOT the correct classification.
...
Heading (bold, ONE line, ~20 characters or fewer):
人工の運河用水路も地目変更
Illustration: An isometric land plot showing a small boat passing through
an artificial water channel dug into the land. A wooden signboard reads
「運河用地」. A green checkmark stamp reads 「地目変更」, while a separate
red stamp reading 「滅失」 has a large red X mark over it.
Conclusion tag (green banner below the illustration, 5-15 characters):
地目変更（運河用地）
...
it, and a red checkmark stamp reading 「滅失登記」 being pressed onto the
submerged plot.
Conclusion tag (green banner below the illustration, 5-15 characters):
自然の滅失
...
crumbling into the sea from a cliff collapse, while most of the plot
remains solid land. An arrow points to a checkmark stamp reading
「地積変更登記」, and a separate red stamp reading 「滅失」 has a large
red X mark over it.
Conclusion tag (green banner below the illustration, 5-15 characters):
地積変更
...
Heading (bold, ONE line, ~20 characters or fewer):
起算点は「知った日」じゃない
Illustration: An isometric calendar showing a land plot crumbling into the
sea marked on one date, with a 「1か月」 countdown arrow starting exactly
from that date. A separate calendar page labeled 「知った日」 has a
magnifying glass and a large red X mark over it, showing this later date
