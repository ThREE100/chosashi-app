## 【土地家屋調査士受験生向け】平成29年度 第5問・登記識別情報は「誰に」「いつまでに」通知される？〜合筆登記のパスワード事情〜
...
「誰に通知される・されないか」（ア・イ・オ、うちオは誤りの肢を正しいルールに直したもの＝列A・緑）と、「いつまでに受け取らないと通知されないか」（ウ・エ＝列B・青）の2系統に分け、通し番号1〜5の5枚のカードで一枚に俯瞰できる構成にした。導入イラスト・導入文のブロックは置かず、タイトル・サブタイトル直後からカード群に入る。

```
Create a Japanese-language infographic, portrait layout, 1080x1920 pixels,
clean flat-design isometric illustration style with soft pastel colors
(blue, green, beige, gray), rounded card sections, consistent with a
modern explainer-graphic aesthetic (icons: a registry office counter, a
password/key card icon representing 登記識別情報, two land plots merging
into one for 合筆, a mortgage ribbon icon, a government-building icon, a
laptop with a countdown calendar, an envelope/paper being handed over, red
X marks and green check marks, etc. — adapt icon set to the topic).
...
--- HEADER ---
Title (large, bold, 1行):
登記識別情報は「誰に」「いつまでに」通知される？

Subtitle (smaller, centered, 1行):
平成29年度　午後の部　第5問－合筆登記のパスワード事情
...
「いらない」と申し出れば通知されない
Illustration: 登記所の窓口で申請人Aが「通知は希望しません」という吹き出しを出している。窓口の奥にあるパスワードカード（登記識別情報）アイコンに赤い✕マークが重なり、発行されないことを示す。
...
合筆登記で抵当権者には通知されない
Illustration: 甲土地と乙土地が矢印で合体して一つの土地になるイラスト。所有権登記名義人Aにはパスワードカードが手渡される矢印（✓マーク）が伸びるが、同じ土地に付いた抵当権を示すリボンアイコンのBには、パスワードカードへ伸びる矢印に赤い✕マークが重なる。
...
Heading (bold, ONE line, ~20 characters or fewer):
官庁も希望すれば通知される
Illustration: 官公庁の建物アイコンが「登記名義人」として登記所の窓口に立ち、「通知を希望します」という吹き出しを出している。窓口からその官庁アイコンへパスワードカードが手渡される矢印に緑の✓マーク。
Conclusion tag (green, 5-15 characters):
申出があれば通知
...
Heading (bold, ONE line, ~20 characters or fewer):
電子申請は30日以内にダウンロード
Illustration: 資格者代理人Bがノートパソコンの前に座り、画面にダウンロードボタンとパスワードカードのアイコンが表示されている。横のカレンダーに「30日」のカウントダウン表示。期限を過ぎたダウンロードボタンには赤い✕マーク。
...
Heading (bold, ONE line, ~20 characters or fewer):
書面申請は完了から3月以内に受領
Illustration: 資格者代理人Bが登記所の窓口へ書面（パスワードカードが印字された紙）を受け取りに来ているイラスト。横のカレンダーに「3か月」のラベル。期限を過ぎた書面アイコンには赤い✕マーク。
Conclusion tag (blue, 5-15 characters):
3か月で受領期限
