...
- **イ（誤）**　地番変更で必要なのは建物図面のみで、各階平面図までは不要（令別表14項添付情報イ）
...
- 各肢の根拠について、ア（不動産登記法52条1項）、ウ（不動産登記法52条3項）、エ（不動産登記規則134条3項・124条）、オ（民法423条、不動産登記法16条2項の準用）は、いずれもデータベースのexplanationフィールドで条文番号まで明記されているものです。
