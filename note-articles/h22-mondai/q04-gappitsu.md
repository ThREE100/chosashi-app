...
Title (large, bold, 1行):
くっつけられる土地 くっつけられない土地


Subtitle (smaller, centered, 1行):
平成22年度　午後の部　第4問　合筆の登記の制限
...
Illustration: Two land-plot icons (甲・乙) both stamped「敷地権」, with a merge-arrow between them crossed out by a large ✕.
...
Illustration: Two land plots each showing a 「破産手続開始」stamp being replaced by a 「終結」stamp (checkmark), with a merge-arrow between them showing ✓, no scissors/eraser icon needed.
...
Illustration: Two land plots each with a 信託目録 document icon showing identical content, with a merge-arrow between them and a checkmark labeled「内容が同一ならOK」.
...
Heading (bold, ONE line, ~20 Japanese characters or fewer):
財産管理人の合筆申請に家裁の許可はいらない

Illustration: A court-building icon (家庭裁判所) with a ✕ mark, next to a 不在者財産管理人 character confidently stamping a merge application without needing the court's permission slip.
