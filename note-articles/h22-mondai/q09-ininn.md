...
登記の申請の委任による代理人の権限は、本人である法人の代表者の交代によっても消滅しません（不動産登記法17条2号）。したがって、委任を受けた後に法人の代表者が替わっても、代理人は当該登記の申請をすることができます。この記述は正しいものです。
...
| イ | 正 | 法人の代表者の交代でも代理権は消滅しない（法17条2号） |
...
- 各肢の根拠のうち、ア・イ（登記申請の委任は本人の死亡・法人代表者の交代で消滅しない）は不動産登記法17条、オ（代理人の死亡による代理権の消滅）は民法111条1項2号から確認できるものです。ウ（官公署が職務上作成した委任状の3か月制限の除外）・エ（補正のための取下げに特別の委任が不要であること）は、不動産登記令・実務の一般的な理解に基づくもので、条文の細かな項番号までは個別に照合しきれていない部分があります。各自でも条文を確認することをおすすめします。
