## 【土地家屋調査士受験生向け】平成21年度 第3問〜遺産分割、合意ならやり直せても不履行では解除不可〜
...
- **オ（誤）**　「相続させる」旨の遺言＝特定財産承継遺言（民法1014条2項）の対象財産は原則分割の対象外
...
family figures, will scrolls, registry books, stamps, torn paper labels).
...
全員の合意ならできる、一人の不履行ではできない(平成21年度 午後の部 第3問)
...
全員の合意ならやり直せる
Illustration: an isometric round table with three seated family figures,
each with a small green ✓ above their head and a shared label 「全員」. On the
table an agreement sheet labeled 「分割協議」 is being torn, and a curved
arrow loops back to a fresh blank sheet labeled 「再協議」 with a green ✓.
...
Heading (bold, ONE line):
超過部分は登記がなければ不可
Illustration: an isometric land plot split into a shaded base portion
labeled 「法定相続分」 and a highlighted extra slice labeled 「超過部分」. An
arrow runs from the extra slice toward a buyer figure labeled 「第三者」 and
is blocked by a red ✕. A registry book icon on the arrow is stamped with a
small tag 「登記が必要」.
...
Heading (bold, ONE line):
不履行でも法定解除できない
Illustration: an isometric scene with one figure handing over a house icon
and the other figure holding an empty money bag stamped 「未払」. A large
scissors icon aimed at the sheet labeled 「分割協議」 is crossed out with a
red ✕. Beside it a separate small arrow labeled 「支払請求」 carries a green
✓.
Conclusion tag (short green banner/pill):
解除は認められない
...
Heading (bold, ONE line):
放棄者は当事者になれない
Illustration: an isometric meeting table with three seated figures and one
faded translucent figure standing outside a dashed boundary, labeled
「相続放棄者」 and marked with a red ✕. Three small speech bubbles from the
seated figures reading 「同意」 are themselves crossed out with a smaller red
✕ to show consent does not help.
Conclusion tag (short green banner/pill):
初めから相続人でない
...
Heading (bold, ONE line):
相続させる遺言は分割対象外
Illustration: an isometric will scroll labeled 「遺言」 with an arrow running
straight from it to a house icon held by a single figure labeled 「C」,
marked with a green ✓ and a small tag 「死亡と同時」. A separate arrow that
would route the same house into a meeting table labeled 「遺産分割」 is
