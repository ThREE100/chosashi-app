...
- **委任による代理人の権限を証する情報のうち、官庁又は公署の作成に係るもの**：委任状そのものではなく、代理権限の裏付けとして官公署が作成した書面（成年後見登記事項証明書など）を添付する場合も、作成後3か月以内のものでなければなりません（不動産登記令17条1項）。
...
- **古い教材に残る「1か月以内」という記述**：会社法人等番号を有する法人が、番号に代えて代表者の資格を証する登記事項証明書を提供する場合（不動産登記規則36条1項・2項）の有効期限は、平成27年11月2日から令和2年3月29日までは「作成後1か月以内」でしたが、令和2年3月30日施行の改正で「作成後3か月以内」に変更されています。古い過去問解説やテキストでは「1か月」のまま止まっていることがあるため、現行は3か月であることを確認してください。
...
- **3か月以内が必要**：①申請書に押印した印鑑の証明書（令16条3項）、②委任状に押印した印鑑の証明書（令18条3項）、③会社法人等番号を提供しない法人の代表者資格証明情報（令17条1項）、④代理権限証明情報のうち官公署作成のもの（令17条1項）
...
- 条文根拠（不動産登記令16条3項・17条1項・18条3項・19条1項・2項、不動産登記規則36条1項・2項）は、ローカル法令データベース（`laws/fudousan-touki-rei.md`・`laws/fudousan-touki-kisoku-1.md`）の条文原文をGrep・Readして確認済みです。特に「令19条には16条3項・18条3項に相当する期間制限の項が存在しない」という消極的事実、および「代理権限証明情報のうち官公署作成のものも17条1項でカバーされる（17条2項は官公署の嘱託の場合の適用除外規定であり、期間制限そのものを定めた規定ではない）」という点も、条文原文で確認済みです。この照合の過程で、当初「不動産登記令17条2項」「不動産登記規則36条3項」としていた条項番号の誤りを、それぞれ「17条1項」「36条1項・2項」に修正しています。
- なお、不動産登記規則47条は「申請書に記名押印を要しない場合」を定める規定であり、印鑑証明書の要否そのものを定める条文ではないこともあわせて確認しました。
- 不動産登記規則36条1項・2項の代表者資格証明情報（登記事項証明書）の有効期限が「1か月以内→3か月以内」に改正された時期（令和2年3月30日施行）については、複数の解説記事で一致した記述に加え、既存記事`note-articles/h28-mondai/q06-tochihyouji-shinseijouhou.md`（2026-08-18に法令照合済み）の記述とも一致することを確認しましたが、改正省令の原文そのものまでは確認できていません。
