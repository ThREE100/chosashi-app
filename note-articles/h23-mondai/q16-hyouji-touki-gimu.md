## 【土地家屋調査士受験生向け】平成23年度 第16問〜地目変更登記、起算点は取得日じゃない〜
...
### 肢エ：地目変更後に取得した人の起算点は、所有権の登記があった日であって取得日ではない
...
Heading (bold, ONE line, ~20 characters or fewer):
新所有者の起算点は登記日
Illustration: A forest-labeled land plot growing a house on it, with a
later buyer character's 取得日 (purchase date) marked with a red X as
the wrong starting point, and a green flag placed instead on the buyer's
own 所有権移転登記 (registration) date on a calendar.
Conclusion tag (green banner below the illustration, 5-15 characters):
所有権登記日が起点
