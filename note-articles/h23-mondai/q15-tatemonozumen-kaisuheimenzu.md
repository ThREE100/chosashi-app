## 【土地家屋調査士受験生向け】平成23年度 第15問〜規約敷地の追加だけなら建物図面は不要〜
...
### ア：建物を分割するときは、床面積が変わらなくても各階平面図が要る

甲建物から乙建物を分割する登記は、それまで一体だった建物の登記記録を分けて、新たに独立した建物として起こす手続です。分割後の建物の床面積そのものに変更がなくても、分割によって新しく生まれる建物の各階の形状を明らかにする必要があるため、各階平面図の添付を要します（不動産登記令別表十六の項）。「添付を要しない」とする本肢は誤りです。

**たとえば**、母屋とつながっていた離れを登記記録上も独立した1個の建物として分割するときは、離れの床面積が元の登記と変わっていなくても、その離れの各階平面図をあらためて提出する必要があります。

### イ：規約敷地を追加するだけなら、建物図面は要らない

区分建物について新たに規約を定め、別の土地（乙土地）をその区分建物の規約敷地とする登記は、建物の物理的な位置や形状を変えるものではなく、法律上「建物の敷地」とみなす土地の範囲を追加する手続にすぎません。この登記の添付情報を定めた規定にも建物図面は掲げられておらず（不動産登記令別表十五の項）、建物図面は建物の位置・形状を示す図面なので、この登記では添付を要しません。

**たとえば**、マンションの敷地として隣接する駐車場用地を新たに規約で「敷地」に加える手続をしても、建物そのものの位置や形は変わらないので、あらためて建物図面を出す必要はありません。

### ウ：増築で一棟に変更があっても、一棟全体の図面までは要らない
...
### エ：仮換地上の建物は、仮換地の形を実線で描き、将来の地番は括弧書きにする
...
### オ：使われなくなった建物図面の保存期間は30年

建物図面は原則として永久に保存されますが、閉鎖されたものについては保存期間が閉鎖の日から30年と定められています（不動産登記規則28条13号）。曳行移転によって建物の所在が変わり、不要になった従前の建物図面はこの「閉鎖されたもの」にあたります。
