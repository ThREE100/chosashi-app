...
実体上の所有者と表題部所有者が食い違う場合の更正の登記は、実体上の所有者しか申請できません（不動産登記法33条1項）。添付情報としても、表題部所有者の承諾を証する情報のほか、表題部所有者に対抗することができる裁判があったことを証する情報を提供すればよいとされています（不動産登記令別表二の項）。したがって実体上の所有者Bは、Aに対抗できる裁判があったことを証する情報を提供して申請することができます。
...
- 肢イ・肢ウの根拠は、ローカル法令データベース（`note-articles/laws/fudousan-touki-hou.md`）で不動産登記法33条（表題部所有者の更正の登記等）1項・3項・4項の条文原文を直接確認済みです。肢アは、不動産登記法27条1号（登記原因及びその日付が登記事項であること）と38条・53条（この事項に関する更正の登記を表題部所有者等が申請できること）で確認しました。肢ウ・エ・オの添付情報の具体的な中身（対抗できる裁判があったことを証する情報、公務員作成情報に代わるべき情報、住所を証する情報）は、`note-articles/laws/fudousan-touki-rei-betsuhyou.md`（不動産登記令別表）の一の項・二の項・三の項で条文上確認済みです（一の項＝表題部所有者の氏名等の更正、二の項＝表題部所有者についての更正、三の項＝共有者の持分についての更正）。
