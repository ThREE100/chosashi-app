## 【土地家屋調査士受験生向け】平成23年度 第2問〜反射的利益だけでは時効は援用できない〜
...
時効の援用権者の範囲を「直接利益を受けて援用できる者」と「反射的利益や信義則により援用できない者」という2つの軸に沿って、通し番号バッジ・短い見出し・図解・短い結論タグだけで構成する2列・5枚のポスター型カードで俯瞰する構成。

```
Create a Japanese-language infographic, portrait layout, 1080x1920 pixels,
clean flat-design isometric illustration style with soft pastel colors
(blue, green, beige, gray), rounded card sections, consistent with a
modern explainer-graphic aesthetic (icons: isometric people, contract
documents, clocks, land plots, house icons, stamps, torn paper labels,
...
kanji 権・続・証・約 — these must be rendered in their standard Japanese
...
below holds the stamp directly with a checkmark.
Conclusion tag (blue banner below the illustration, 5-15 characters):
間接的利益
...
attention to 権・続・証・約. If any character renders as a Simplified
