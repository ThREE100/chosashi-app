...
├── h27-mondai/             平成27年度 午後の部(第1問〜第20問、全問完成・インフォグラフィックプロンプト追加・最新法令チェック済み)
...
**平成27年度分（h27-mondai）は、全20問について作成・ダブルチェック・重複出題チェック・インフォグラフィックプロンプト追加に加えて、ユーザーから提供された不動産登記法・土地家屋調査士法・民法の現行条文全文と全記事中の条文引用を条文番号・項号レベルで突き合わせる現行法チェックまで完了しています**。この突き合わせにより、第2問（民法252条本文→現行の252条1項）・第14問（民法252条ただし書→現行の252条5項）・第19問（不動産登記法28条の補記）・第20問（土地家屋調査士法5条5号・42条3号・29条1項1号の特定）を修正しました。各記事末尾の確認事項ブロックに、修正の経緯を記載しています。
