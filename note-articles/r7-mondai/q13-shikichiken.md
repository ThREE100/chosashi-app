## 【土地家屋調査士受験生向け】令和7年度 第13問〜敷地権の登記がある土地同士「合筆×」、建物同士「合併〇」〜
...
- **ウ（誤）**　敷地権の登記がある土地同士は合筆できない
- **エ（正）**　敷地権登記の有無が食い違っていても建物の合併はできる
- **オ（正）**　分離処分可能規約のある部屋を除いて一括で敷地権付き表題登記ができる

敷地権に関する登記は、「土地側でできないこと」と「建物側で認められること」を条文ごとに区別して覚えると得点につながります。
...
- さらに読者から、エについて「甲の敷地権が乙にも及んで、合併後の建物全体が敷地権付きになるのではないか」という追加の疑問があったため、「ここが分かりにくいポイント」に、敷地権が建物1棟単位ではなく区分建物ごとの専有部分割合に結びついた登記であること、合併により専有部分の範囲が変わる以上、乙の分の裏付けを欠いたまま甲の敷地権をそのまま引き継ぐことができないことを補足しました。この「なぜ敷地権のない建物になるのか」という理由づけ自体は、規則134条3項・124条という条文の裏付けはあるものの、敷地権制度の一般的な考え方から導いたものであり、この場面に固有の先例・通達の文言そのものは確認できていません（該当しそうなウェブページには接続できず未確認）。実務で使う際は念のため確認することをおすすめします。
...
land plots, registration document stamps, address tags, torn paper labels,
