## 【土地家屋調査士受験生向け】令和7年度 第12問・建物の「種類」、正しい決め方・記録のされ方〜専有部分ごとの記録・共用部分の職権抹消・多目的ビルの不可・教習所・給油所〜
...
- **エ（正）**　学校教育法の適用外の学習塾は「教習所」と定めることができる（準則80条1項後段の適宜定める枠）
...
Caption (small text below):
学校教育法の適用を受けない学習塾などの施設は、準則80条1項後段の「その他
適宜定める」枠により、種類を「教習所」と定めることができる。
...
Column B Card 1 reads exactly "店舗・遊技場・映画館" — three terms,
