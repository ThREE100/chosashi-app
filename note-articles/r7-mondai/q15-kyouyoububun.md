...
- 出題番号・正解番号（2番＝ア・ウ）は法務省公表の試験問題原本・正答資料で確認済みです。イ（不動産登記法58条6項・7項により、1か月の申請義務は規約を廃止した場合に限られ、規約設定時にはない）は条文で確認済みです。オ（他棟の区分所有者の氏名は不要だが家屋番号は必要）は不動産登記令別表18項申請情報欄で確認済みです。エ（共有者全員申請が必須とは限らない）については、共有者全員必須の明文はないものの、確実に不要と断定できる一次資料までは確認できておらず、やや保留です。実務で使う際は念のため再確認をおすすめします。
