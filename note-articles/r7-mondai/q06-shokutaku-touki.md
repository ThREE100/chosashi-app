## 【土地家屋調査士受験生向け】令和7年度 第6問〜市の建物なら、証明書はいらないんです〜
...
- **エ（正）**　河川区域化した土地は河川管理者が代わりに分筆登記を嘱託できる
- **オ（誤）**　希望の申出があれば登記識別情報は通知される
...
- 出題番号・正解番号（5番＝ウ・オ）は法務省公表の試験問題原本・正答資料で確認済みです。ア（不動産登記令別表4の項添付情報欄ハ）・イ（不動産登記令17条1項・2項）も条文上確認済みです。オの根拠（不動産登記規則64条1項4号、希望申出があれば通知）は公共嘱託登記実務の解説書で確認済みです。エの根拠（法43条4項、河川管理者による分筆登記の嘱託）も同資料で確認済みです。ウの根拠（所有権を証する情報の省略について不動産登記事務取扱手続準則87条3項、印鑑証明書の省略について令16条4項・18条4項）も条文上確認済みです。
