...
不動産登記法43条4項により、河川区域内の土地の登記については、河川管理者が嘱託権者として明確に認められています。
...
- **エ（正）**　河川区域化した土地は河川管理者が代わりに分筆登記を嘱託できる（法43条4項）
- **オ（誤）**　希望の申出があれば登記識別情報は通知される（規則64条1項4号）

嘱託登記は「官公署だから何でも免除される」わけではありません。印鑑証明書の提供や委任状の作成期限のように、官公署自身が嘱託する場合に限って免除される手続と、所有権の証明のように免除されない手続とが、条文ごとに細かく分かれている点を押さえておきましょう。
...
- 出題番号・正解番号（5番＝ウ・オ）は法務省公表の試験問題原本・正答資料で確認済みです。オの根拠（不動産登記規則64条1項4号、希望申出があれば通知）は公共嘱託登記実務の解説書で確認済みです。エの根拠（法43条4項、河川管理者による分筆登記の嘱託）も同資料で確認済みです。ウの根拠（所有権を証する情報の省略について不動産登記事務取扱手続準則87条3項、印鑑証明書の省略について令16条4項・18条4項）も条文上確認済みです。
