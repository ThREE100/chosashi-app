...
分筆の登記（不動産登記法39条）は、地積更正や地目変更など、他の登記と一緒に一の申請情報でまとめて申請できる場面が多くあります。まとめて申請できる場合は、不動産登記令4条ただし書と不動産登記規則35条が定めています。この問題は、そのときに「何を添付すれば足りるか」「何を申請情報に書かなければならないか」を細かく問うものです。
...
- ア（地積更正との一括申請での地積測量図の範囲）とエ（地目変更との一括申請での登記原因・日付記載）は、分筆の登記に関する一般的な取扱いに基づく説明で、確度は比較的高いと考えています。一方、イ（相続人からの申請での相続人全員の氏名・住所記載の要否）とウ（敷地権付き区分建物の法定敷地の分筆と分離処分可能規約の要否のタイミング）は、正解の組合せ（アエ）から逆算して合理的に説明したものであり、**根拠となる条文・先例は今回の再検証でも特定できていません**。特にウについては、分離処分可能規約が「分筆の段階」と「所有権移転の段階」のどちらで必要になるかという点で、実務上さらに詳しい確認が望ましい箇所です。
