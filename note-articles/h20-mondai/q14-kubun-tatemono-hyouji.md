...
区分建物の床面積は、壁その他の区画の内側線で囲まれた部分の水平投影面積によって求めます。柱が壁面より内側に突き出て凹凸がある場合にこれを反映させるかどうかは条文自体には明記されていませんが、公式正答（イエ）に照らすと、柱部分の凹凸はないものとして壁面のみで囲まれた部分を基準に求積する扱いが前提とされています。
...
区分建物が属する一棟の建物が新築された場合の表題登記の申請は、他の区分建物についての表題登記の申請と「**併せてしなければならない**」と不動産登記法で定められています。これは同時申請の要求であって、「一の申請情報によって申請しなければならない」という意味ではないため、本肢は誤りです。
...
表示に関する登記は、民法その他の法令の規定により他人に代わって（代位して）申請することができます。区分建物を原始取得者から取得した転得者は、原始取得者が表題登記を申請しない場合、この代位の仕組みを使って自ら表題登記を申請できるため、本肢は正しい記述です。
