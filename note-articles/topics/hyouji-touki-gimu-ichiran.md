## 【土地家屋調査士受験生向け】表示に関する登記の申請義務(1か月以内)一覧〜どの登記に義務があり、いつから数えるか〜

**対象条文：不動産登記法36条・37条・38条・39条・42条・47条・49条・51条・53条・57条・58条・164条、不動産登記規則92条**
...
この分野を整理する最大の軸が、**「変更」は申請義務があり、「更正」は申請義務がない**という対比です。

- **変更**は、登記された後に事実が変わったことを登記に反映させる手続です。地目が変わった、床面積が増築で変わった、といった「後発的な事実の変動」を扱うため、37条・51条のように申請義務と1か月の期限が課されています。
- **更正**は、登記時点から誤っていたことを正しく直す手続です。誤りにいつ気づくかは人によってまちまちで、期限を区切ること自体になじまないため、38条・53条には期限の定めがありません。

**たとえば**、表題登記のときの図面の計算ミスで地積が違っていた場合、これは「後から地積が変わった」のではなく「最初から間違っていた」ケースなので、地積更正の登記を申請することになりますが、この申請には1か月以内という期限はありません(令和4年度午後の部第7問ウ)。一方、雑種地だった土地に建物を建てて宅地として使い始めた場合は、地目が現実に変わったのですから、変更があった日から1か月以内に地目変更登記を申請する義務が生じます(同問エ)。
...
- 不動産登記法36条・37条1項2項・38条・39条・42条・47条1項・49条1項3項4項・51条1項〜4項・53条・57条・58条6項7項・164条1項、不動産登記規則92条は、いずれも`note-articles/laws/fudousan-touki-hou.md`および`note-articles/laws/fudousan-touki-kisoku-1.md`の一次資料を実際にGrep・Readし、条文番号・文言を確認したうえで記載しています。とくに164条1項は、過料の対象となる申請義務の条文番号を法律自身が列挙しており、「表示に関する登記のうち1か月以内の義務があるもの」の一覧の裏付けとして使っています。
- 早見表①・②および「起算点が特殊なケース」の表に記載した各ケースは、条文本体の確認に加えて、対応する過去問記事(下記「参照した過去問」欄)の解説内容とも突き合わせています。
- 31条(表題部所有者の氏名等の変更・更正登記)については、条文上「表題部所有者以外の者は、申請することができない」という申請適格の制限があるのみで、期限を定める規定が存在しないことを条文の通読で確認しました。「義務がない」という結論は、条文に義務規定がないという消極的な確認にとどまります。
...
- 「変更」は義務あり、「更正」は義務なし、って知ってました？
- その登記、1か月の起算点はどこから数えますか？
- 行政区画が変わっても、申請義務は生じないんです
- 相続を重ねても、表題登記の義務は消えないんです
- 表示登記の申請義務、条文が過料でリスト化してるんです
...
- [H26第7問 表示に関する登記の申請義務](../h26-mondai/q07-shinsei-gimu.md)
- [H29第15問 建物の表示に関する登記の申請義務](../h29-mondai/q15-tatemono-shinsei-gimu.md)
- [R1第6問 土地の滅失の登記](../r1-mondai/q06-tochi-messitsu.md)
- [R1第16問 不動産の表示に関する登記の申請義務](../r1-mondai/q16-hyouji-touki-shinsei.md)
- [R3第17問 建物の滅失に関する登記](../r3-mondai/q17-tatemono-messitsu.md)
- [R3第18問 共用部分である旨の登記](../r3-mondai/q18-kyouyoububun.md)
- [R4第7問 土地の表題部の変更又は更正の登記](../r4-mondai/q07-hyoudaibu-hensei-kousei.md)
- [R4第15問 合体による登記等](../r4-mondai/q15-gattai-touki.md)
- [R4第18問 敷地権に関する登記](../r4-mondai/q18-shikichiken.md)
