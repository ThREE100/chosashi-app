...
**未成年者**
- 対象となる判断能力の程度：―（年齢基準）
- 保護開始の手続：不要（18歳未満で自動的に該当、4条）
- 本人以外の請求に本人の同意が必要か：―（該当なし）
- 保護者の呼び名：親権者・未成年後見人
- 本人の行為の原則：同意が必要（5条1項）、例外あり
- 唯一／主な例外：単に得する行為、処分を許された財産の範囲内、許可された営業の範囲内（5条1項ただし書・3項、6条1項）
- 保護者の代理権：法律上当然に包括的（824条本文）

**成年被後見人**
- 対象となる判断能力の程度：事理を弁識する能力を欠く常況
- 保護開始の手続：後見開始の審判（7条）
- 本人以外の請求に本人の同意が必要か：不要
- 保護者の呼び名：成年後見人
- 本人の行為の原則：原則すべて取消し可（9条本文）
- 唯一／主な例外：日用品の購入その他日常生活に関する行為（9条ただし書）
- 保護者の代理権：法律上当然に包括的（859条1項）

**被保佐人**
- 対象となる判断能力の程度：事理を弁識する能力が著しく不十分
- 保護開始の手続：保佐開始の審判（11条）
- 本人以外の請求に本人の同意が必要か：不要
- 保護者の呼び名：保佐人
- 本人の行為の原則：原則単独で可、13条1項列挙行為だけ同意必要
- 唯一／主な例外：13条2項で家裁が対象を追加可
- 保護者の代理権：審判で個別付与（876条の4）

**被補助人**
- 対象となる判断能力の程度：事理を弁識する能力が不十分
- 保護開始の手続：補助開始の審判（15条）
- 本人以外の請求に本人の同意が必要か：**必要**（15条2項）
- 保護者の呼び名：補助人
- 本人の行為の原則：原則単独で可、審判で指定した特定の行為だけ同意必要
- 唯一／主な例外：17条1項ただし書で13条1項行為の一部に限定
- 保護者の代理権：審判で個別付与（876条の9）
...
- 本人以外の請求に本人同意が必要か：不要
- 同意が必要な行為の範囲：―（原則取消し可）
- 保護者の代理権：当然に包括的（859条1項）
- 本人への催告の効力：無効（成年後見人へ）
- 詐術による取消権喪失：適用あり（21条）
- 審判相互の調整：保佐・補助開始中の者に後見開始→もとの審判を取消し（19条）

**被保佐人**
- 本人以外の請求に本人同意が必要か：不要
- 同意が必要な行為の範囲：13条1項列挙行為＋13条2項で追加可
- 保護者の代理権：審判で個別付与（876条の4）
- 本人への催告の効力：有効（20条4項、無回答は取消し擬制）
- 詐術による取消権喪失：適用あり（21条）
- 審判相互の調整：成年被後見人・被補助人であるときに保佐開始→その審判を取消し（19条2項）

**被補助人**
- 本人以外の請求に本人同意が必要か：必要（15条2項）
- 同意が必要な行為の範囲：17条1項の審判で個別指定（13条1項行為の一部に限定）
- 保護者の代理権：審判で個別付与（876条の9）
- 本人への催告の効力：有効（20条4項、無回答は取消し擬制）
- 詐術による取消権喪失：適用あり（21条）
- 審判相互の調整：成年被後見人・被保佐人であるときに補助開始→その審判を取消し（19条2項）
...
- 文章としてはこのままnoteに貼り付けて投稿できる内容です。当初はMarkdownの表（4類型比較・暗記すべき事項のまとめ）を使っていましたが、noteは表組みを描画できないため、4類型それぞれを見出しにした箇条書きブロックに書き直しました。
- 本文中の民法4条〜21条・102条（`laws/minpou-1-soukyoku-bukken.md`に収録）、824条本文・859条1項・876条の4第1項〜第3項・876条の9第1項〜第2項・961条（`laws/minpou-3-shinzoku-souzoku.md`に収録）の各条文番号は、いずれもローカルの法令データベースの条文原文とGrep・Readで突き合わせて確認済みです。なお、876条の9第2項は条文自体に「本人の同意」という文言はなく、876条の4第2項・第3項を準用する形で同じ効果（本人以外の請求による代理権付与の審判には本人の同意が必要）を生じさせている点に留意してください。今回のレビューで、これまでこのブロックに記載されていた120条・859条の3は、本文中のどこにも引用箇所がないことが判明したため、誤って記載されていたものとして削除しました。
...
- 「催告の効果が正反対になる」点（狙われやすい勘違いポイント・暗記すべき事項のまとめ参照）は、20条1項〜4項の4パターン（本人への催告が無効な場合／法定代理人等への催告／特別の方式を要する行為／被保佐人・被補助人本人への催告）として、`note-articles/column/saikokuken-4pattern.md` によりくわしく整理していますので、あわせてご参照ください。
