...
過去問データベースでは、「持分がAは5分の3・5分の2、Bは5分の2・5分の3」というように持分の内訳が逆転している場合も41条4号の「持分を異にする」に該当し合筆できない、という肢（令和6年度午後の部第9問）が確認できています。また、41条2号の「地目」は登記記録上の地目ではなく現況の地目を基準に判断するため、登記記録上の地目が同一であっても現況地目が異なる場合には合筆できません（令和6年度午後の部第9問イ、正解は「誤り」）。
...
- **根拠条文**：土地の合筆は不登法41条（全6号）。建物の合併は不登法56条（全5号）
- **接続（隣接）要件**：土地の合筆には**あり**（1号：相互に接続していない土地は不可）。建物の合併には条文上の独立要件としては明記がない（区分合併は54条1項3号の定義自体に「接続する」区分建物である旨が組み込まれている）
- **用途・種類の同一性**：土地の合筆には**あり**（2号：地目が相互に異なる土地は不可）。建物の合併には条文上の独立要件としては明記がない（建物の種類が異なることを理由とする制限は56条に規定なし）
- **地番区域・所在の同一性**：土地の合筆には**あり**（2号：地番区域が相互に異なる土地は不可）。建物の合併には該当する要件がない
- **表題部所有者・登記名義人の同一性**：土地の合筆（3号）・建物の合併（2号）とも**あり**
- **持分の同一性**：土地の合筆（4号）・建物の合併（3号）とも**あり**
- **所有権の登記の有無の一致**：土地の合筆（5号：所有権登記の有無が異なる土地は不可）・建物の合併（4号：所有権登記の有無が異なる建物は不可）とも**あり**
- **所有権以外の権利の登記**：土地の合筆（6号）・建物の合併（5号）とも**原則不可、例外あり**
- **共用部分・団地共用部分の登記**：土地の合筆には条文上の規定がない（土地に共用部分の概念はない）。建物の合併には**あり**（1号：共用部分・団地共用部分の登記がある建物は不可）
- **制限の例外（特例）を定める規則**：土地の合筆は不登規則105条（全4号）。建物の合併は不登規則131条（全2号）
...
- 「土地の合筆の登記の制限」節の持分逆転の例は、令和6年度午後の部第9問（`r6-mondai/q09-gappitsu-touki.md`）のkaisetsu_plus.jsonエントリ（reviewed: true）から確認したものです。
- **訂正（2026-09-08実施）**：本記事は当初「41条2号は登記記録上の地目を基準とする」と記載していましたが、これは誤りでした。既存のR6第9問イの解説記事（`r6-mondai/q09-gappitsu-touki.md`）および公式正答（同肢イは「誤り」）を確認したところ、41条2号の「地目」は現況の地目を基準に判断するものであり、登記記録上の地目が同一であっても現況地目が異なれば合筆できないという結論が正しいことが判明したため、本文を訂正しました。
