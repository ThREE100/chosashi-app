...
- **法定相続情報一覧図の写し**：相続人の住所が記載された法定相続情報一覧図の写し（または法定相続情報番号）を提供したときは、相続を証する情報だけでなく、登記名義人となる者の住所を証する情報の提供も兼ねることができます（不動産登記規則37条の3第1項・第2項）。**ただし、これはあくまで別に添付する証明書類（添付情報）を省略できるという話であり、申請書そのものに書き込むべき記載事項（申請情報）まで免除するものではありません。**表示に関する登記を表題部所有者又は所有権の登記名義人の相続人が申請するときは、法定相続情報一覧図を提供した場合でも、「申請人が相続人その他の一般承継人である旨」を申請情報の内容としなければなりません（不動産登記令3条10号、令和6年度午後の部第8問ウ）。
