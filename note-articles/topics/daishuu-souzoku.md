## 【土地家屋調査士受験生向け】代襲相続、家系図で正確に整理する〜「誰が」「なぜ」「どこまで」を一気に解説〜

代襲相続は、土地家屋調査士試験の民法分野で繰り返し出題される頻出テーマです。令和6年度・平成30年度にはそれぞれ代襲相続だけを問う問題が出題されており、令和3年度・平成26年度・平成21年度の問題でも他の論点と組み合わせて登場しています。この記事では、代襲相続の基本的な仕組みから、初学者がつまずきやすい「誰が代襲できるのか」「どこまで代襲できるのか」という2つの論点を、家系図を使って整理します。

### 基本知識：代襲相続とは何か

代襲相続とは、被相続人の子が、相続の開始以前に死亡したとき、または相続欠格・廃除によってその相続権を失ったときに、その者の子（被相続人から見れば孫）が、その者に代わって相続人となる制度です（民法887条2項）。
...
**たとえば**、多額の借金を残して亡くなったＡさんの子Ｂさんが相続放棄をしたとします。この場合、Ｂさんの子Ｃさん（Ａさんの孫）が、Ｂさんに代わってその借金を代襲相続してしまうことはありません。放棄は、その家系を丸ごと相続から外す効果を持つのです。
...
### ④兄弟姉妹の代襲は「一代限り」、子の系統は「再代襲」あり

代襲がどこまで続くかは、被代襲者が「子」の系統か「兄弟姉妹」の系統かで結論が異なります。

- **子の系統：再代襲あり**：代襲者自身も、相続開始以前に死亡し、または欠格・廃除によって代襲相続権を失った場合には、さらにその子が代襲します（民法887条3項）。孫が代襲者になった後、その孫も死亡等していれば、ひ孫がさらに代襲する、という形で続いていきます。
- **兄弟姉妹の系統：一代限り**：兄弟姉妹が相続人となる場合の代襲は、民法887条2項の規定を準用することで認められますが（民法889条2項）、この889条2項は887条3項（再代襲）までは準用していません。そのため、兄弟姉妹の代襲は、その者の子（甥・姪）までで打ち止めとなり、甥・姪がさらに死亡等していても、その子（甥・姪の子）が再代襲することはできません。
...
- **令和6年度午後の部第3問**：養子の代襲可否、胎児の代襲、廃除による代襲、配偶者の連れ子の代襲不可、直系尊属は固有の権利で相続人となる旨が、まとめて出題されています。
- **平成30年度午後の部第3問**：直系尊属は被代襲者とならない旨、相続放棄は代襲原因とならない旨、廃除後に生まれた子も代襲する旨、兄弟姉妹の系統では再代襲ができない旨、相続欠格は代襲原因となる旨が、まとめて出題されています。
- **令和3年度午後の部第3問・平成26年度午後の部第3問**：代襲相続そのものは主題ではありませんが、代襲者と養子の二重資格（令和3年度）、同時死亡の推定によって代襲相続が問題となる場面（平成26年度）など、代襲相続の理解が前提知識として問われています。
- **平成21年度午後の部第3問**：代襲相続そのものは登場しませんが、相続放棄をした者は初めから相続人でなかったものとみなされる旨（民法939条）など、代襲相続の理解とも関わる相続法の周辺論点を扱っています。
...
**兄弟姉妹の系統でも再代襲できると思い込む**：子の系統では孫・ひ孫へと再代襲が続くため、同じ発想を兄弟姉妹の系統にも当てはめてしまいがちです。しかし、兄弟姉妹の代襲を定める民法889条2項は、再代襲を定める887条3項を準用していません。「系統によって代襲の続く範囲が違う」という前提を先に押さえておく必要があります。

**配偶者の連れ子と、養子縁組した子を混同する**：どちらも「血のつながらない子」という点では似ていますが、養子縁組をしていれば法定血族関係が生じて直系卑属として代襲できるのに対し、単なる連れ子（養子縁組をしていない）は直系卑属にあたらず代襲できません。「血がつながっているかどうか」ではなく「法律上の親族関係があるかどうか」で判断する点に注意が必要です。

### 代襲相続の判定フローチャート

代襲相続の問題は、次の順序で考えると迷わず処理できます。

1. 被相続人の子（または兄弟姉妹）が、相続開始以前に死亡・欠格・廃除のいずれかによって相続権を失っているか。→ 当てはまらない（生存している、または放棄しただけ）なら、代襲の問題ではない。
2. 代襲の候補者は、被代襲者の直系卑属といえるか（実子・被相続人の死亡以前に縁組が成立した養子・生きて生まれた胎児は直系卑属にあたる。配偶者の連れ子・直系尊属は直系卑属にあたらない）。→ 直系卑属にあたらないなら、代襲相続人にならない。
3. 被代襲者は「子」の系統か、「兄弟姉妹」の系統か。→ 子の系統なら、代襲者自身が死亡等した場合にさらに再代襲する。兄弟姉妹の系統なら、その者の子（甥・姪）で代襲は打ち止めとなる。
...
- 民法727条・886条・887条1項〜3項・889条1項1号・2項・891条・892条・893条・939条の各条文番号は、`laws/minpou-3-shinzoku-souzoku.md`の条文原文をGrep・Readして確認済みです。
- 各論点の出典（令和6年度午後の部第3問、平成30年度午後の部第3問の各肢の内容・正誤判定）は、既存の個別解説記事`note-articles/r6-mondai/q03-daishuu-souzoku.md`・`note-articles/h30-mondai/q03-daishuu-souzoku.md`と照合しています。両記事とも、条文原文との突き合わせ（h30側は2026-08-18に実施済み）が既に行われており、本記事の内容と整合していることを確認しました。
- 令和3年度午後の部第3問・平成26年度午後の部第3問・平成21年度午後の部第3問については、代襲相続が副次的な論点として登場する既存記事（`note-articles/r3-mondai/q03-souzoku.md`・`note-articles/h26-mondai/q03-souzokunin-hani.md`・`note-articles/h21-mondai/q03-isanbunkatsu.md`）の内容を要約したものであり、これら3問について改めて条文原文との個別の突き合わせは行っていません。
- 判定フローチャートの3ステップは、既存2記事が扱う論点を整理するために本記事で新たに構成したものであり、条文・先例上の固定された手順として定められているものではありません。あくまで学習上の思考整理の道具としてご利用ください。
...
- 代襲相続、家系図で見ると迷わないんです
- 放棄した人の子は、代襲できないって知ってた？
- 養子でも、縁組が先なら代襲できるんです
- 兄弟姉妹の代襲は、甥っ子・姪っ子で打ち止めなんです
- 祖父母は「代襲」じゃなく自分の権利で相続人になるんです
...
```
Create a Japanese-language infographic, portrait layout, 1080x1200 pixels,
clean flat-design isometric illustration style with soft pastel colors
(blue, green, beige, gray), a single centered family-tree diagram,
consistent with a modern explainer-graphic aesthetic (icons: isometric
person figures labeled Ａ・Ｂ・Ｃ, a tombstone icon for death, a dashed
arrow representing succession-by-representation, a solid line
representing a direct parent-child relationship — adapt icon set to the
topic).

GLANCEABLE-POSTER REQUIREMENT (critical): This is a quick-reference poster,
NOT a text-heavy explainer document. There is NO paragraph of prose
anywhere on this poster other than the short labels specified below. Every
relationship must be shown through the family-tree lines and icons
themselves, not through sentences.
...
Ｂが先に死亡していたら、Ｃが代わって相続する

（タイトル・サブタイトルのすぐ下に家系図を続ける。導入イラスト・導入文の
ブロックは置かない。）

--- FAMILY TREE DIAGRAM ---
Layout: a vertical 3-generation tree, exactly 3 person icons, laid out
top to bottom.

Row 1 (top, centered): person icon labeled Ａ, with a small text tag
「被相続人」directly beneath the icon.

Row 2 (middle, centered directly below Ａ): person icon labeled Ｂ,
connected to Ａ above by a solid vertical line (実線, representing the
parent-child relationship). Ｂ's icon is drawn semi-transparent / grayed
out with a small tombstone icon overlaid, and a text tag「先に死亡」
directly beneath the icon. A second small text tag「被代襲者」sits just
below the「先に死亡」tag.

Row 3 (bottom, centered directly below Ｂ): person icon labeled Ｃ,
connected to Ｂ above by the same style solid vertical line (実線, the
biological parent-child relationship between Ｂ and Ｃ). A separate
curved dashed arrow (点線の矢印, representing 代襲 succession-by-
representation, visually distinct from the solid lines) runs from Ｃ's
icon up and around directly to Ａ's icon, bypassing Ｂ. A text tag
「代襲相続人」sits directly beneath Ｃ's icon, and a small label
「代襲」is placed at the midpoint of the dashed arrow.

--- LEGEND (small, bottom corner) ---
実線：親子関係　　点線の矢印：代襲

--- FOOTER ---

Final check before rendering: scan every kanji glyph, paying special
attention to 続・襲・被・相・続・人, and confirm each is standard Japanese
(Jōyō) form, not Simplified Chinese. If any character renders as a
Simplified Chinese variant, redraw that character in the correct Japanese
form. Confirm the diagram contains exactly 3 person icons (Ａ・Ｂ・Ｃ) in
exactly 3 rows, confirm the solid lines (実線) and the dashed
...
(icons: isometric person figures labeled Ａ・Ｂ・Ｃ, a tombstone icon for
death, a red prohibition circle for disqualification, a small court-gavel
or hanko stamp for family-court disinheritance, a torn-paper tag for
renunciation, dashed arrows for succession-by-representation — adapt icon
set to the topic).
...
through the family-tree illustration (icons, arrows, X marks, small
...
body text anywhere on the poster.
...
ブロックは置かない。列を分けないため、バッジ色は1色に統一する。各カードの
家系図は、Ａを最上段、Ｂを中段、Ｃを下段に統一した同じレイアウトで描く。）
...
middle with a tombstone icon labeled 死亡, Ｃ at the bottom connected to
Ｂ by a solid line and to Ａ by a dashed succession arrow labeled 代襲.
...
Heading (bold, ONE line, ~20 Japanese characters or fewer):
欠格は代襲原因
Illustration: The same 3-row layout, Ｂ stamped with a red prohibition
circle labeled 欠格, the prohibition mark stopping exactly at Ｂ and not
extending onto the line toward Ｃ, and a dashed succession arrow from Ｃ
to Ａ labeled 代襲.
Conclusion tag (blue banner, 5-15 Japanese characters):
Ｃは代襲相続人
...
Heading (bold, ONE line, ~20 Japanese characters or fewer):
廃除は代襲原因
Illustration: The same 3-row layout, Ｂ stamped with a small
court-gavel/hanko icon labeled 廃除, and a dashed succession arrow from
Ｃ to Ａ labeled 代襲.
Conclusion tag (blue banner, 5-15 Japanese characters):
Ｃは代襲相続人
...
containing a small family-tree diagram, consistent with a modern
explainer-graphic aesthetic (icons: isometric person figures labeled
Ａ・Ｂ・Ｃ・Ｄ, a tombstone icon for death, dashed succession arrows, a
red "STOP" prohibition mark — adapt icon set to the topic).

GLANCEABLE-POSTER REQUIREMENT (critical): This is a quick-reference poster,
NOT a text-heavy explainer document. There is NO intro illustration and NO
paragraph of prose anywhere on this poster — go straight from the header
to the two columns. Every column must communicate its point almost
entirely through the family-tree illustration plus one short heading and
one short conclusion tag. Do NOT render any full-sentence explanation or
...
clean flat-design isometric illustration style with soft pastel colors
(blue, green, beige, gray), a top-to-bottom decision-tree flowchart with
diamond-shaped decision nodes and rounded rectangle result nodes,
consistent with a modern explainer-graphic aesthetic (icons: a small
family-tree glyph at each decision node, checkmark/X icons at result
nodes — adapt icon set to the topic).

GLANCEABLE-POSTER REQUIREMENT (critical): This is a quick-reference
flowchart, NOT a text-heavy explainer document. There is NO intro
illustration and NO paragraph of prose anywhere on this poster other than
the short node labels specified below — go straight from the header to
the flowchart. Do NOT render any full-sentence explanation or legal
citation anywhere on the poster; every node must read as a short question
or short conclusion at a glance.
...
Node 1 (diamond, decision node, top):
被相続人の子・兄弟姉妹が、死亡・欠格・廃除で
相続権を失っているか？
...
Node 2 (diamond, decision node, middle):
代襲の候補者は、被代襲者の直系卑属といえるか？
（実子・死亡以前に縁組した養子・生きて生まれた
胎児はOK。配偶者の連れ子・直系尊属はNG）

Branch 2-No (arrow labeled いいえ、leading to a rounded rectangle result
node, styled red with a ✕ icon):
代襲相続人にならない

Branch 2-Yes (arrow labeled はい、leading down to Node 3):

Node 3 (diamond, decision node, bottom):
被代襲者は「子」の系統か、
「兄弟姉妹」の系統か？

Branch 3-Child (arrow labeled 子の系統、leading to a rounded rectangle
result node, styled green with a checkmark icon):
代襲相続人となる
（さらに死亡等なら再代襲も続く）

Branch 3-Sibling (arrow labeled 兄弟姉妹の系統、leading to a separate
rounded rectangle result node, styled green with a checkmark icon):
代襲相続人となる
（ただし甥・姪の1代限りで打ち止め）
...
decision nodes in top-to-bottom order and exactly 4 result nodes total
(1 from Node 1's いいえ branch, 1 from Node 2's いいえ branch, and 2 from
...
- [令和6年度午後の部第3問（代襲相続）](../r6-mondai/q03-daishuu-souzoku.md)
- [平成30年度午後の部第3問（代襲相続）](../h30-mondai/q03-daishuu-souzoku.md)
- [令和3年度午後の部第3問（相続）](../r3-mondai/q03-souzoku.md)
- [平成26年度午後の部第3問（相続人の範囲）](../h26-mondai/q03-souzokunin-hani.md)
- [平成21年度午後の部第3問（遺産分割）](../h21-mondai/q03-isanbunkatsu.md)
