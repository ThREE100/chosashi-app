...
back to an applicant with a glowing 還付請求できる stamp, while a
certified-copy icon (謄本) stays behind in the registry's files.
Conclusion tag (blue banner below the illustration, 5-15 characters):
原本還付は可能
...
additional text block of any kind — the poster ends immediately after
the last card), and confirm the entire canvas, edge to edge, is filled
...
Subtitle (smaller, centered, 1行):
平成28年度午後第5問 作図ガイド（特例方式の書面提出と還付）
