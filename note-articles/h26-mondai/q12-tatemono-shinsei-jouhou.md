...
同一の登記所に対して同時に2件以上の申請をする場合、各申請に共通する添付情報を1つの申請の申請情報とあわせて提供したときは、その旨（当該添付情報をその1つの申請とあわせて提供したこと）を、他の申請の申請情報の内容として記載しなければなりません。添付情報を二重に提出する手間を省くための仕組みです。この規定が適用されるのは「二以上の申請」をする場合であり、3件以上に限らず、ちょうど2件の同時申請でも適用されます。

**たとえば**、同じ登記所に対して同時に2件の登記を申請する際、両方に共通して必要な書類（住所証明情報など）を1件目の申請書にだけ添付したとします。この場合、2件目の申請書には「その共通の書類は1件目の申請とあわせて提供した」という旨を記載する必要があります。これは3件以上の同時申請でも同様で、共通の書類を添付しなかった申請書のすべてに、この記載が必要になります。
