## 【土地家屋調査士受験生向け】平成26年度 第18問〜地役権図面はオンラインで請求できるんです〜
...
1. 不動産登記法121条1項は、登記簿の附属書類のうち「写しの交付」を請求できるものを、政令（不動産登記令21条1項）で定める図面に限定しています。
2. 不動産登記令21条1項が定める図面は、土地所在図・地積測量図・地役権図面・建物図面・各階平面図の5種類だけです。
3. 「敷地権に関する規約を設定したことを証する情報を記載した書面」は、この5種類のいずれにも当たりません。したがって、利害関係の有無を論じる以前に、そもそも写しの交付を請求できる書類ではありません。
4. この書面について認められているのは、あくまで「閲覧」です。不動産登記法121条3項により、正当な理由があるときに、その正当な理由があると認められる部分に限って閲覧を請求できるにとどまります。

「利害関係があるかどうか」で判断するのではなく、「そもそも写しの交付の対象になる書類か」を先に確認する、という2段階の思考が、この肢を正しく解くための鍵です。
...
- **エ（誤）**　規約を証する情報を記載した書面は、5種類の図面（土地所在図・地積測量図・地役権図面・建物図面・各階平面図）に当たらず、そもそも写しの交付を請求できない
...
を証する情報" stored in the registry archive, clearly separate from a
group of 5 icons labeled "土地所在図・地積測量図・地役権図面・建物図面・
各階平面図" (the only 5 document types eligible for copies). A person
requests a "写しの交付" of the 規約証明情報 document at the counter and is
refused with a large red X; instead, the clerk allows only "閲覧"（正当な
理由がある部分に限る）shown with a small magnifying-glass icon and a
green checkmark.
Conclusion tag (green banner below the illustration, 5-15 characters):
写しの交付は不可
...
--- HEADER ---
Title (large, bold):
証明書は「1つの不動産ごと」とは限らない

Subtitle (smaller, centered):
平成26年度 午後の部 第18問 イ－一棟建物現在事項証明書（規則196条1項）

--- COMPARISON ---
LEFT PANEL (beige, heading「ありがちな思い込み」):
登記事項証明書は、1つの区分建物ごとに
不動産番号や家屋番号を指定して請求するもの
→「一棟まとめて」の証明書は存在しないはず

RIGHT PANEL (green, heading「実際の6種類（規則196条1項）」):
一号 全部事項証明書／二号 現在事項証明書／三号 何区何番事項証明書／
四号 所有者証明書／五号 一棟建物全部事項証明書／
六号 一棟建物現在事項証明書（本肢はこれ）

--- CALLOUT: 誤りやすいポイント ---
五号・六号は、一棟の建物に属するすべての区分建物をまとめて証明する、
区分建物特有の証明書です。六号「一棟建物現在事項証明書」は、過去の履歴
まで含む五号の「全部事項」とは異なり、「現に効力を有するもの」に限定
される点もあわせて押さえてください。

--- FOOTER ---
根拠条文：不動産登記規則196条1項5号・6号。判例・先例の具体的な番号は
ここには書かない。
...
Subtitle (smaller, centered):
平成26年度 午後の部 第18問 エ－写しの交付を請求できる書類の限定列挙

--- FLOWCHART ---
Start node (rectangle, isometric document icon labeled "登記簿の附属書類
の写しの交付を請求したい"):
規約を証する情報を記載した書面について、写しの交付を請求したい

Down arrow to Decision node (diamond icon):
その書類は、不動産登記令21条1項が定める5種類の図面（土地所在図・地積測量
図・地役権図面・建物図面・各階平面図）のいずれかに当たるか？

Branch left（あたる、green checkmark）:
Result node: 不動産登記法121条1項により、誰でも写しの交付を請求できる
（利害関係は不要）

Branch right（あたらない、本肢のケース、highlighted）:
Result node: 写しの交付はそもそもできない。121条3項により、正当な理由が
あるときに、その正当な理由があると認められる部分に限り、閲覧を請求でき
るにとどまる

--- CALLOUT: 誤りやすいポイント ---
本肢の文言「利害関係を有する部分に限り、写しの交付を請求することができ
る」を見ると、つい「利害関係の有無」で判断してしまいます。しかし先に
確認すべきは「そもそも写しの交付の対象になる書類か」であり、対象外の
書類については、利害関係があってもなくても写しの交付自体ができません。

--- FOOTER ---
根拠条文：不動産登記法121条1項・3項、不動産登記令21条1項。判例・先例の
具体的な番号はここには書かない。
...
Subtitle (smaller, centered):
平成26年度 午後の部 第18問 オ－119条1項と2項、5項の特則が及ぶ範囲

--- COMPARISON ---
LEFT PANEL (green, heading「119条1項：登記事項証明書」):
登記記録に記録されている事項の全部又は一部を証明した書面
119条5項の特則により、所在地以外の登記所でも請求できる
→ 全国どこの登記所でも取得可能

RIGHT PANEL (beige, heading「119条2項：登記事項概要証明書（本肢）」):
登記記録に記録されている事項の概要を記載した書面
119条5項は「第一項の交付の請求」に限定されており、2項には及ばない
→ 不動産の所在地を管轄する登記所に対してのみ請求できる

--- CALLOUT: 誤りやすいポイント ---
「登記事項証明書は全国どこでも取れる」という有名な原則を、似た名前の
「登記事項概要証明書」にもそのまま当てはめてしまいがちです。しかし
119条5項は「第一項の交付の請求」とだけ定めており、2項には及びません。
名前が似ていることと、適用される条文が同じであることは別問題です。

--- FOOTER ---
根拠条文：不動産登記法119条1項・2項・5項。判例・先例の具体的な番号は
ここには書かない。
