...
複数の地番にまたがって建物が所在する場合、不動産登記事務取扱手続準則88条2項により、所在の記録は「床面積の多い部分又は主たる建物の所在する土地の地番を先に記録し、他の土地の地番は後に記録する」こととされています。先頭に記録するのが床面積の多い土地（本問では200㎡の2番地）である点は肢ウの記述と一致しますが、同項は先頭の1筆を定めるだけで、残り3筆についてまで床面積の大小順に並べることまでは定めていません。したがって、床面積順（200㎡、150㎡、120㎡、100㎡の順）にすべての地番を「2番地，4番地，3番地，1番地」と記録しなければならない、という記述は誤りです。
